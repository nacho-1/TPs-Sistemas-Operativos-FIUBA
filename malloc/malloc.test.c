...
static void
realloc_expect_reuse_actual_space_bigger_size(void)
{
	char *reg1 = malloc(SMALL_BLOCK_SIZE * 2 / 7);
	char *reg2 = malloc(SMALL_BLOCK_SIZE * 2 / 7);
...
static void
realloc_expect_reuse_actual_space_smaller_size(void)
{
	char *reg1 = malloc(SMALL_BLOCK_SIZE * 2 / 7);
	char *reg2 = malloc(SMALL_BLOCK_SIZE * 4 / 7);

	char *reg3 = realloc(reg2, SMALL_BLOCK_SIZE * 3 / 7);
...
main(void)
{
	...
	run_test(realloc_expect_reuse_actual_space_bigger_size);
	run_test(realloc_expect_reuse_actual_space_smaller_size);
